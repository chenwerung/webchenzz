...
<div class="container-fluid">
    ...
    <div class="col-12">
        <div class="row">
            <div class="col-md-6">
                <div class="form-group">
                    <label for="vehicle_type" class="control-label">Tipe Kendaraan</label>
                ...
                <div class="form-group">
                    <label for="contact" class="control-label">Kontak Pemilik #</label>
                ...
                <div class="form-group">
                    <label for="email" class="control-label">Email Pemilik</label>
            ...
            <div class="col-md-6">
                ...
                <div class="form-group">
                    <label for="vehicle_registration_number" class="control-label">Plat Nomor Kendaraan</label>
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-group " id="mechanic-holder">
                    <label for="mechanic_id" class="control-label">Mekanik yang ditugaskan:</label>
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <select name="status" id="status" class="custom-select custom-select-sm rounded-0" required>
                        <option value="0" <?php echo isset($status) && $status == 0 ? "selected" : '' ?>>Tertunda</option>
                        <option value="1" <?php echo isset($status) && $status == 1 ? "selected" : '' ?>>Dikonfirmasi</option>
                        ...
                        <option value="4" <?php echo isset($status) && $status == 4 ? "selected" : '' ?>>Dibatalkan</option>
                    </select>
                </div>
            </div>
        </div>
        ...
        <div class="w-100 d-flex justify-content-end mx-2">
            <div class="col-auto">
                <button class="btn btn-primary btn-sm rounded-0">Simpan Permintaan</button>
