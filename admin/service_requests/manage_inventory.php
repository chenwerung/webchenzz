...
<div class="card card-outline card-info">
	...
	<div class="card-body">
		<form action="" id="inventory-form">
            ...
            <div class="form-group">
				<label for="quantity" class="control-label">Kualitas Awal</label>
	...
	<div class="card-footer">
		<button class="btn btn-flat btn-primary" form="inventory-form">Simpan</button>
		<a class="btn btn-flat btn-default" href="?page=inventory">Batal</a>
	</div>
</div>
<script>
