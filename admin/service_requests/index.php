...
<div class="card card-outline card-primary">
	<div class="card-header">
		<h3 class="card-title">Daftar Permintaan Servis</h3>
					...
					?>
						<tr>
							...
							<td class="text-center">
								<?php if($row['status'] == 1): ?>
									<span class="badge badge-primary rounded-pill px-3">Dikonfirmasi</span>
								...
								<?php elseif($row['status'] == 4): ?>
									<span class="badge badge-danger rounded-pill px-3">Dibatalkan</span>
								<?php else: ?>
									<span class="badge badge-secondary rounded-pill px-3">Tertunda</span>
								<?php endif; ?>
							</td>
							<td align="center">
								 <button type="button" class="btn btn-flat btn-default btn-sm dropdown-toggle dropdown-icon" data-toggle="dropdown">
				                  ...
				                  <div class="dropdown-menu" role="menu">
				                    <a class="dropdown-item view_data" href="javascript:void(0)" data-id="<?php echo $row['id'] ?>"><span class="fa fa-eye text-primary"></span> Lihat</a>
...
<script>
	$(document).ready(function(){
		...
		$('.view_data').click(function(){
			uni_modal("Detail Permintaan Servis","service_requests/view_request.php?id="+$(this).attr('data-id'),'large')
		})
		$('#create_new').click(function(){
			uni_modal("Detail Permintaan Servis","service_requests/manage_request.php",'large')
		})
		$('.edit_data').click(function(){
			uni_modal("Detail Permintaan Servis","service_requests/manage_request.php?id="+$(this).attr('data-id'),'large')
		})
		$('.table').dataTable();
	})
