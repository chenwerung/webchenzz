    ...
    <div class="card card-outline rounded-0 card-primary shadow">
        <div class="card-header">
            ...
            <div class="card-tools">
                <a href="javascript:void(0)" id="add_new" class="btn btn-flat btn-sm btn-primary"><span class="fas fa-plus"></span>  Tambak Stok</a>
                <a class="btn btn-default border btn-sm btn-flat" href="./?page=inventory"><i class="fa fa-angle-left"></i> Kembali</a>
            </div>
        </div>
        <div class="card-body">
            <div class="container">
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <small class="mx-2 text-muted">Nama Brand</small>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <small class="mx-2 text-muted">Model yang cocok</small>
                        ...
                        <table class="table table-bordered table-stripped">
                            ...
                            <thead>
                                <tr class="bg-light text-light">
                                    <th class="py-1 text-center">Tanggal Dibuat</th>
                                    <th class="py-1 text-center">Stok</th>
                                    <th class="py-1 text-center">Tindakan</th>
                                </tr>
                            </thead>
                            <tbody>
                                <?php 
                                    ...
                                    <tr>
                                        ...
                                        <td class="px-2 py-1 align-middle">
                                            ...
                                            <div class="dropdown-menu" role="menu">
                                                <a class="dropdown-item edit_data" href="javascript:void(0)" data-id="<?php echo $row['id'] ?>"><span class="fa fa-edit text-dark"></span> Ubah</a>
...
<script>
    $(document).ready(function(){
        $('#add_new').click(function(){
			uni_modal("Tambah Stok Baru","inventory/manage_stock.php?pid=<?= isset($id) ? $id : "" ?>")
		})
        $('.edit_data').click(function(){
			uni_modal("Edit Stok","inventory/manage_stock.php?id="+$(this).attr('data-id'))
		})
		$('.delete_data').click(function(){
			_conf("Yakin akan menghapus stok produk permanen?","delete_stock",[$(this).attr('data-id')])
		})
    })
