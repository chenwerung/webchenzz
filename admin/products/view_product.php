    ...
    <div class="card card-outline rounded-0 card-primary shadow">
        <div class="card-header">
            ...
            <div class="card-tools">
                <a class="btn btn-primary btn-sm btn-flat" href="./?page=products/manage_product&id=<?= isset($id) ? $id : "" ?>"><i class="fa fa-edit"></i> Ubah</a>
                <a class="btn btn-danger btn-sm btn-flat" href="javascript:void(0)>" id="delete_data"><i class="fa fa-trash"></i> Hapus</a>
                <a class="btn btn-default border btn-sm btn-flat" href="./?page=products"><i class="fa fa-angle-left"></i> Kembali</a>
            </div>
        </div>
        <div class="card-body">
            <div class="container">
