<h1 class="">Selamat Datang di Administrator <?php echo $_settings->info('name') ?></h1>
<hr>
<div class="row">
          ...
          <div class="col-12 col-sm-6 col-md-3">
            <div class="shadow info-box mb-3">
              ...
              <div class="info-box-content">
                <span class="info-box-text">Mekanik</span>
                <span class="info-box-number">
                  <?php 
          ...
          <div class="col-12 col-sm-6 col-md-3">
            <div class="shadow info-box mb-3">
              ...
              <div class="info-box-content">
                <span class="info-box-text">Pesanan Tertunda</span>
                <span class="info-box-number">
                <?php 
          ...
          <div class="col-12 col-sm-6 col-md-3">
            <div class="shadow info-box mb-3">
              ...
              <div class="info-box-content">
                <span class="info-box-text">Pengiriman Pesanan</span>
                <span class="info-box-number">
                <?php 
          ...
          <div class="col-12 col-sm-6 col-md-3">
            <div class="shadow info-box mb-3">
              ...
              <div class="info-box-content">
                <span class="info-box-text">Pesanan dalam Perjalanan</span>
                <span class="info-box-number">
                <?php 
          ...
          <div class="col-12 col-sm-6 col-md-3">
            <div class="shadow info-box mb-3">
              ...
              <div class="info-box-content">
                <span class="info-box-text">Pesanan Terkirim</span>
                <span class="info-box-number">
                <?php 
          ...
          <div class="col-12 col-sm-6 col-md-3">
            <div class="shadow info-box mb-3">
              ...
              <div class="info-box-content">
                <span class="info-box-text">Permintaan Selesai</span>
                <span class="info-box-number">
                <?php 
