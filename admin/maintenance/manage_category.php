...
<div class="card card-outline card-info">
	<div class="card-header">
		<h3 class="card-title"><?php echo isset($id) ? "Update ": "Tambah " ?> Kategori</h3>
	</div>
	<div class="card-body">
	...
	<div class="card-footer">
		<button class="btn btn-flat btn-primary" form="category-form">Simpan</button>
		<a class="btn btn-flat btn-default" href="?page=maintenance/category">Batal</a>
	</div>
</div>
<script>
