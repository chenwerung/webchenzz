				...
				<tbody>
					...
					?>
						<tr>
							...
							<td class="text-center">
                                <?php if($row['status'] == 1): ?>
                                    <span class="badge badge-success mx-3 rounded-pill">Aktif</span>
                                <?php else: ?>
                                    <span class="badge badge-danger mx-3 rounded-pill">Tidak Aktif</span>
                                <?php endif; ?>
                            </td>
							<td align="center">
...
<script>
	$(document).ready(function(){
		$('.delete_data').click(function(){
			_conf("Yakin akan menghapus brand ini permanen?","delete_brand",[$(this).attr('data-id')])
		})
        $('#create_new').click(function(){
            uni_modal("Tambah Brand Baru","maintenance/manage_brand.php","mid-large")
        })
        $('.edit_data').click(function(){
            uni_modal("Tambah Brand Baru","maintenance/manage_brand.php?id="+$(this).attr('data-id'),"mid-large")
        })
