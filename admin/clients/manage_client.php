...
<div class="card card-outline card-info">
	<div class="card-header">
		<h3 class="card-title"><?php echo isset($id) ? "Update ": "Create New " ?> Detail Customer</h3>
	</div>
	<div class="card-body">
	...
	<div class="card-footer">
		<button class="btn btn-flat btn-primary" form="client-form">Simpan</button>
		<a class="btn btn-flat btn-default" href="?page=clients">Batal</a>
	</div>
</div>
<script>
